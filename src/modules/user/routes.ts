...
router.get("/:id", validate({body: onlyIdSchema}),userController.getOneUser);
...
router.delete("/:id", validate({body: onlyIdSchema}),userController.deleteUser); //to change the password
